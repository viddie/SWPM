...
- das Abheben von der Konkurrenz in Wettbewerbs-starken Branchen
...
Die gewählten und definierten Qualitätsziele werden dann zusammen in einen Qualitätsplan geschrieben, der über das gesamte Projekt Geltung hat.
...
Des Weiteren kann der Meilensteinplan wichtige kundenbezogene, technische oder finanzielle Meilensteine enthalten, z. B. wann der Kunde wie viel Prozent des Gesamtpreises bezahlt oder Termine für Überprüfungen, angestrebte Genehmigungen, Probeläufe, Abnahme und Übergabe.
...
Die Hauptaufgabe der Planung der konkreten Termine hat der Projektcontroller. Dieser legt die den Meilensteinplan zusammen mit dem Kunden bzw. dem Projektcharta fest. Der Masterterminplan wird anschließend zusammen mit allen Beteiligten des Projektteams schrittweise erstellt.
...
**Netzplantechnik**
Die Netzplantechnik, auch wenn der Name eigentlich nur ein Oberbegriff für vielerlei Methoden ist, ist für komplexe Projekte mit vielerlei Abhängigkeiten geeignet. Mit Hilfe von einem Netz bestehend aus Knoten und Kanten und einem sogenannten **kritischen Weg** lässt sich leicht die erforderliche Mindestlaufzeit eines Projektes modellieren. Jegliche Pfade deren Verzögerung den vereinbarten Termin des Projektendes nicht nach hinten verschieben, sofern sie nicht übermäßig verzögern, heißen nicht-kritische Vorgänge. Sie sind nicht ausschlaggebend für das Bestehen des Projekts, weshalb sie meistens **KANN**-Vorschläge des Kunden sind.
...
Insgesamt ist es sehr kompliziert, alle Zwecke der Aufwandsschätzung korrekt mit einzubeziehen. Dafür gibt es eine umfangreiche Sammlung an Methoden, die sich der "integrierten Projektkostenplanung" widmen.
...
Die parametrische Methode hingegen ist geeigneter für komplexere Projekte. Sie untersucht abgeschlossene Projekte mit Hilfe von Regressionsanalyse auf Wirkungszusammenhänge, mit dem Ziel, Algorithmen zu entwickeln, die den Aufwand des eigenen Projekts präziser schätzen können. Das parametrische Modell greift jedoch auch nicht allgemein, da für eine solche Analyse umfangreiche Kostendatenbanken zur Verfügung stehen müssen.
...
Die Plankosten sind die reinen Kosten, unter der Annahme, dass nichts im Projekt schiefläuft. Dazu kommen allerdings die Risikozuschläge, die dafür geplant sind, Risiken, die als wahrscheinlich genug für einen Eintritt eingestuft sind, abwenden zu können.
